# fablink_project/settings/k8s_fixed.py
# Kubernetes 배포용 설정 (ALLOWED_HOSTS 문제 해결)
...
# 호스트 설정 (모든 호스트 허용 - K8s 환경용)
ALLOWED_HOSTS = ['*']  # K8s 환경에서는 모든 호스트 허용
...
# 보안 설정 (프로덕션용이지만 K8s 환경 고려)
if not DEBUG:
    SECURE_BROWSER_XSS_FILTER = True
    SECURE_CONTENT_TYPE_NOSNIFF = True
    # X_FRAME_OPTIONS = 'DENY'  # K8s 환경에서는 주석 처리
